...
const Projects = ({portfolio}) => {
    ...
    const professional_projects = [
        { title: 'Apply to Vet Schoold', url: null, image: './images/vet.jpg', description: ['Online Veterinary School Catalog.', 'Headless Wordpress website built with <a href="https://reactjs.org/" target="_blank" rel="noreferrer">React</a> and <a href="https://nextjs.org/" target="_blank" rel="noreferrer">NextJS</a>.', 'Uses <a href="https://www.wpgraphql.com/" target="_blank" rel="noreferrer">WPGraphQl</a> and <a href="https://www.apollographql.com/" target="_blank" rel="noreferrer">Apollo</a>.'] },
    ...
    const personal_projects = [
        { title: 'Scales Buddy', url: 'https://scalesbuddy.com', image: './images/scales_buddy.jpg', description: ['Practice and learn the scales on the freboard.', 'Built with <a href="https://reactjs.org/" target="_blank" rel="noreferrer">React</a>.'] },
        { title: 'Portfolio Site', url: 'https://www.iamguido.com', image: './images/portfolio.jpg', git: 'https://github.com/cguidog/portfolio_2019', description: ['The same website you are at right now.', 'Built with <a href="https://reactjs.org/" target="_blank" rel="noreferrer">React</a>.', 'Uses Babel, Express, SVG & Webpack.'] },
