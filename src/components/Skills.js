const Skills = () =>
    <div id="about" className="about">
        ...
        <div className="skills animated bounceInRight delay-2s">I build beautiful websites and web applications with a focus on user experience and accessibility. Check out the Projects section to learn more about my work.</div>
